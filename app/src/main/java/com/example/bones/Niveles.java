...
import com.example.bones.databinding.FragmentNivelesBinding;

public class Niveles extends Fragment {

    FragmentNivelesBinding binding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.boton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.estrategia);
            }
        });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNivelesBinding.inflate(inflater, container, false);
